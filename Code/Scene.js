...
export class Scene {
  constructor() {
    ...
    this.FPSRoot = new Node();
    this.FPSRoot.addComponent(new Transform({ position: [0, 0, 0] }));
    this.scene.addChild(this.FPSRoot);

    this.FPSBody = new Node();
    this.FPSBody.addComponent(new Transform({ position: [0, 1, 0] }));
    this.FPSRoot.addChild(this.FPSBody);
    ...
    this.camera.addComponent(new GoodFPSController(this.FPSRoot, this.FPSBody, this.camera));
    this.FPSBody.addChild(this.camera);
